...
prepareStatement}.
     ...
     */
    public NamedParameter(Connection connection, String query) throws SQLException {
    ...
    public NamedParameter(Connection connection, String query,int resultSetType, int resultSetConcurrency) throws SQLException {
        indexMap=new HashMap();
        try {
    ...
    public void setTimestamp(String name, Timestamp value) throws SQLException
{
    ...
    public void setNull(String name, int nSqlType ) throws SQLException {
        int[] indexes=getIndexes(name);
        for(int i=0; i < indexes.length; i++) {
            statement.setNull(indexes[i] ,nSqlType);
