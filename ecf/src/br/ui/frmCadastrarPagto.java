 ...
 * @author Fernando
 */
public class frmCadastrarPagto extends javax.swing.JDialog {

    /**
     * Creates new form frmCadastrarPagto
     */
    public boolean OK =false;
    public frmCadastrarPagto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        opVinculado = new javax.swing.JRadioButton();
        opNaoVinculado = new javax.swing.JRadioButton();
        ...
        lblTitulo.setText("CADASTRAR PAGAMENTO");
        ...
        jLabel1.setText("DESCRIÇÃO PAGTO (15 CARACTERES)");

        PainelTipoPagto.setBackground(new java.awt.Color(255, 255, 255));
        PainelTipoPagto.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "TIPO DE PAGTO", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 10))); // NOI18N
        PainelTipoPagto.setOpaque(false);

        opVinculado.setBackground(new java.awt.Color(255, 255, 255));
        opVinculado.setText("Vinculado");
        opVinculado.setOpaque(false);

        opNaoVinculado.setBackground(new java.awt.Color(255, 255, 255));
        opNaoVinculado.setText("Não Vinculado");
        opNaoVinculado.setOpaque(false);
        ...
        PainelTipoPagtoLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PainelTipoPagtoLayout.createSequentialGroup()
                .addComponent(opNaoVinculado)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(opVinculado)
                .addContainerGap())
        );
        ...
        PainelCorpoLayout.setHorizontalGroup(
            ...
            .addGroup(PainelCorpoLayout.createSequentialGroup()
                ...
                .addGroup(PainelCorpoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(PainelTipoPagto, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btEditarFormaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarFormaActionPerformed
        ...
        if(txtDescricao.getText().trim().length()==0){
            MetodosUI_Auxiliares_1.MensagemAoUsuarioSimplesAVISO(null, "O CAMPO DESCRICAO NÃO PODE SER VAZIO", lblTitulo.getText());
            return ;
        }
        if(txtDescricao.getText().trim().length()>15){
            MetodosUI_Auxiliares_1.MensagemAoUsuarioSimplesAVISO(null, "O CAMPO DESCRICAO NÃO PODE SER MAIOR QUE 15(QUINZE) CARACTERES", lblTitulo.getText());
            return ;
        }
        if(!opNaoVinculado.isSelected() && !opVinculado.isSelected()){
           MetodosUI_Auxiliares_1.MensagemAoUsuarioSimplesAVISO(null, "ESCOLHA O TIPO DE PAGAMENTO", lblTitulo.getText());
           return;
        }
        OK=true;
        dispose(); 
    ...
    public javax.swing.JRadioButton opNaoVinculado;
    public javax.swing.JRadioButton opVinculado;
