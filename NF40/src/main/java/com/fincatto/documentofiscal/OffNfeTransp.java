 ...
 */
@Entity
@Table(name = "OFF_NFE_TRANSP")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OffNfeTransp.findAll", query = "SELECT o FROM OffNfeTransp o"),
    @NamedQuery(name = "OffNfeTransp.findByCodigonfeTransp", query = "SELECT o FROM OffNfeTransp o WHERE o.codigonfeTransp = :codigonfeTransp"),
    @NamedQuery(name = "OffNfeTransp.findByCodigotransp", query = "SELECT o FROM OffNfeTransp o WHERE o.codigotransp = :codigotransp"),
    @NamedQuery(name = "OffNfeTransp.findByModalidadefrete", query = "SELECT o FROM OffNfeTransp o WHERE o.modalidadefrete = :modalidadefrete"),
    @NamedQuery(name = "OffNfeTransp.findByUltimamodificacao", query = "SELECT o FROM OffNfeTransp o WHERE o.ultimamodificacao = :ultimamodificacao")})
