...
@NamedQueries({
    ...
    @NamedQuery(name = "OffNfceConfig.findByValidanfe", query = "SELECT o FROM OffNfceConfig o WHERE o.validanfe = :validanfe"),
    @NamedQuery(name = "OffNfceConfig.findByAtivanfe", query = "SELECT o FROM OffNfceConfig o WHERE o.ativanfe = :ativanfe")})
public class OffNfceConfig implements Serializable {
    ...
    @Column(name = "VALIDANFE")
    private Short validanfe;
    @Column(name = "ATIVANFE")
    private Short ativanfe;
    ...
    public Serializable getCertificado() {
        return certificado;
    }

    public void setCertificado(Serializable certificado) {
    ...
    public Serializable getCertificadoCadeia() {
        return certificadoCadeia;
    }

    public void setCertificadoCadeia(Serializable certificadoCadeia) {
    ...
    public Short getValidanfe() {
        return validanfe;
    }

    public void setValidanfe(Short validanfe) {
        this.validanfe = validanfe;
    }

    public Short getAtivanfe() {
        return ativanfe;
    }

    public void setAtivanfe(Short ativanfe) {
        this.ativanfe = ativanfe;
    }
    ...
    public String toString() {
        return "main.java.com.fincatto.documentofiscal.OffNfceConfig[ id=" + id + " ]";
    }
