 ...
 */
@Entity
@Table(name = "OFF_NFE_CARTACORRECAO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "OffNfeCartacorrecao.findAll", query = "SELECT o FROM OffNfeCartacorrecao o"),
    @NamedQuery(name = "OffNfeCartacorrecao.findById", query = "SELECT o FROM OffNfeCartacorrecao o WHERE o.id = :id"),
    @NamedQuery(name = "OffNfeCartacorrecao.findByXcorrecao", query = "SELECT o FROM OffNfeCartacorrecao o WHERE o.xcorrecao = :xcorrecao"),
    @NamedQuery(name = "OffNfeCartacorrecao.findByDatahoraevento", query = "SELECT o FROM OffNfeCartacorrecao o WHERE o.datahoraevento = :datahoraevento"),
    @NamedQuery(name = "OffNfeCartacorrecao.findByProtocolo", query = "SELECT o FROM OffNfeCartacorrecao o WHERE o.protocolo = :protocolo"),
    @NamedQuery(name = "OffNfeCartacorrecao.findByDatarec", query = "SELECT o FROM OffNfeCartacorrecao o WHERE o.datarec = :datarec")})
